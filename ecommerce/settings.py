...
SECRET_KEY = ')9ynqjnz&*$%s*gk(%v@g1w*pt-q(4l8pcl-bca0p)@$&rzqiv'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'NB Shop <email@gmail.com>'
...
INSTALLED_APPS = [
    ...
    #local
    #'ecommerce.apps.UsersConfig', # new
    #our apps
    'accounts',
    'addresses',
    'analytics',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dbecom2',             # Nom de la base de données
        'USER': 'basile',
        'PASSWORD': '',        
