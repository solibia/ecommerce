...
def checkout_address_create_view(request):
    print('checkout_address_create_viewwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww')
    ...
    print('beforrrrrrrre form validdddddddddddddddd')
    if form.is_valid():
        print('form validdddddddddddddddd')
        print(request.POST)
        instance = form.save(commit=False)
        billing_profile, billing_profile_created = BillingProfile.objects.new_or_get(request)
        if billing_profile is not None:
            print('biling_profile not nulllllllll')
